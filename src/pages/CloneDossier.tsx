  ...
  const clones = [
    {
      ...
      callSign: "G-01",
      birthPlace: "Камино",
      trainedBy: "Инструкторы ARC, Мандалорские воины",
    ...
    },
    {
      ...
      achievements: ["Операция «Vorna-12»", "Операция: «Устранение»", "Операция: \"Сестема поиска\"", "Операция «Железная стена»", "Операция «Чужой»"],
    ...
    },
    {
      ...
      achievements: ["Операция «Последний рубеж»", "Операция «Vorna-12»", "Операция: «Устранение»", "Операция «Битва при Умбаре»", "Операция «Железная стена»", "Операция «Другой мир»", "Операция «Чужой»"],
