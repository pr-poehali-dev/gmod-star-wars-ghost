            ...
            <div className="relative inline-block">
              ...
              <div className="flex gap-4 justify-center mt-6">
                <div className="bg-orange-400/20 border border-orange-400/40 rounded-full px-4 py-2">
                  <span className="text-orange-300 font-orbitron font-bold text-sm tracking-wider">ARC</span>
                </div>
                <div className="bg-orange-400/20 border border-orange-400/40 rounded-full px-4 py-2">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="animate-fade-in">
              ...
              <p className="text-orange-200 text-lg leading-relaxed text-justify">
                Для их тренировки привлекли мандалорских инструкторов, которые привили им кодекс чести воинов Манд'алор, навыки ведения ближнего боя и умение действовать малыми группами. Дополнительно клоны проходили подготовку у инструкторов ARC (элитного республиканского корпуса), получив опыт ведения диверсионных и зачистных операций.
              </p>
              ...
              <div className="mt-12 pt-8 border-t border-orange-400/30">
                ...
                <div className="space-y-4">
                  <p className="text-orange-200 text-lg leading-relaxed text-justify">
                    Отряд отправляют в 69-й как «обычный отряд ARC». Легион не знает их истинного статуса как БСО и воспринимает как рядовое подкрепление. По документам «Призрак» должен помогать 69-му и служить там!
                  </p>
                  <p className="text-orange-200 text-lg leading-relaxed text-justify">
                    Но их скрытая цель — найти и ликвидировать перебежчика CT-8976, который укрылся на территории легиона. После короткой ложной операции против нескольких дроидов отряд отделяется от 69-го под предлогом проверки сектора и выходит к сигнальной башне, где скрывается цель.
                  </p>
                  <p className="text-orange-200 text-lg leading-relaxed text-justify">
                    Перебежчик оказывается осведомлён о внутренних проблемах Республики и передаёт намёки на утечку информации из Сената. Отряд «Призрак» проводит ликвидацию, уничтожает следы своего присутствия и подделывает обстановку так, будто перебежчика убили дроиды.
                  </p>
                  <p className="text-orange-200 text-lg leading-relaxed text-justify">
                    69-й легион так и не узнаёт, кто такие на самом деле прибыли к ним на помощь и какую настоящую задачу они выполнили. Миссия завершается тем, что «Призрак» уходит оттуда и забирает с собой информацию о возможном предателе в Сенате и продолжает работать в тени.
                  </p>
                </div>
              </div>
            </div>
